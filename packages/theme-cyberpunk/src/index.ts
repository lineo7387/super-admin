...
export const cyberpunkProfile: DesignProfile = {
  ...
  modes: {
    dark: {
      ...
      effects: {
        cardShadow:
          '0 0 0 1px rgba(0, 255, 136, 0.14), 0 0 18px rgba(0, 255, 136, 0.18), 0 24px 70px rgba(0, 0, 0, 0.58)',
        panelShadow:
          '0 0 0 1px rgba(255, 0, 255, 0.16), 0 0 26px rgba(0, 212, 255, 0.2), 0 30px 90px rgba(0, 0, 0, 0.66)',
    ...
    light: {
      ...
      effects: {
        cardShadow:
          '0 0 0 1px rgba(0, 106, 122, 0.12), 0 0 22px rgba(0, 106, 122, 0.16), 0 18px 54px rgba(12, 74, 91, 0.14)',
        panelShadow:
          '0 0 0 1px rgba(184, 0, 130, 0.14), 0 0 26px rgba(184, 0, 130, 0.14), 0 22px 70px rgba(12, 74, 91, 0.18)',
