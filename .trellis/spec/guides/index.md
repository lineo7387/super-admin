...
| [Cross-Layer Thinking](./cross-layer-thinking-guide.md) | Think through frontend state/data/UI boundaries | Features touching shell, modules, API adapters, or queries |
...
| [Semantic Change Checklist](./semantic-change-checklist.md) | Update all consumers when meaning changes | Changing manifest/profile/API adapter semantics |
